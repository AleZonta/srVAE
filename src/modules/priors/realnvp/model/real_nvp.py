...
from ..util.array_util import squeeze_2x2
...
class RealNVP(nn.Module):
    ...
    def __init__(self, input_shape, args, mid_channels=64, num_blocks=5, num_scales=2, prior='std_normal'):
        super().__init__()
        ...
        if prior == 'std_normal':
            ...
            self.prior = MixtureOfGaussians(input_shape, args=args)
